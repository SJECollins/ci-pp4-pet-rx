...
- [Testing](https://github.com/SJECollins/ci-pp4-petrx#testing)
...
- As a site user I can view an animal's entry so that check their details on the database
- As a site user I can edit an animal's entry so that update their details on the database
- As a site user I can create a new prescription so that I can prescribe a medication to an animal and have linked to their details on the database
